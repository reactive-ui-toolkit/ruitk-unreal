...
//
// This lives in RuitkUMG because RuitkCore/RuitkSlate are UObject-free by law
// (D-27). The brush itself is a plain SlateCore type, so RuitkSlate's Image/Border props
