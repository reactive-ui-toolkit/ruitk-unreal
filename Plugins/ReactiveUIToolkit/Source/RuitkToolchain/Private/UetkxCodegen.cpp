...
namespace
{
	...
	const TMap<FName, FTagDef>& HostTags()
	{
		static const TMap<FName, FTagDef> Tags = []()
		{
			...
			M.Add(TEXT("HorizontalBox"),
				  {TEXT("Ruitk::Slate::HorizontalBox"), TEXT("FRuitkHorizontalBoxProps"), true, {}});
			...
			{
				FTagDef T{TEXT("Ruitk::Slate::InlineEditableTextBlock"),
						  TEXT("FRuitkInlineEditableTextBlockProps"),
						  false,
						  {}};
				T.Attrs.Add(TEXT("Text"), EAttrType::Text);
				T.Attrs.Add(TEXT("HintText"), EAttrType::Text);
			...
			{
				FTagDef T{
					TEXT("Ruitk::Slate::VirtualKeyboardEntry"), TEXT("FRuitkVirtualKeyboardEntryProps"), false, {}};
				T.Attrs.Add(TEXT("Text"), EAttrType::Text);
				T.Attrs.Add(TEXT("HintText"), EAttrType::Text);
				T.Attrs.Add(TEXT("bIsReadOnly"), EAttrType::Bool);
			...
			{
				FTagDef T{TEXT("Ruitk::Slate::MultiLineEditableTextBox"),
						  TEXT("FRuitkMultiLineEditableTextBoxProps"),
						  false,
						  {}};
				T.Attrs.Add(TEXT("Text"), EAttrType::Text);
				T.Attrs.Add(TEXT("HintText"), EAttrType::Text);
	...
	FEmittedDecl FEmitter::Emit()
	{
		...
		const FString WrapDecl = FString::Printf(TEXT("inline FRuitkNode %s(%s InProps = %s(), TArray<FRuitkNode> "
													  "InChildren = TArray<FRuitkNode>(), FRuitkKey "
													  "InKey = FRuitkKey());\n"),
		...
		FString Impl = FString::Printf(
			TEXT("static FRuitkNodeArray %s(FRuitkContext& Ctx, const %s& Props, const TArray<FRuitkNode>& "
				 "children)\n{\n"),
			*BodyName, *PropsType);
		for (const FUetkxParam& Param : Decl.Params)
		{
...
bool FUetkxCodegen::IsSellerRepo()
{
	...
	static const bool bSeller = FPaths::FileExists(FPaths::ProjectDir() / TEXT(".ruitk-seller-repo"));
	return bSeller;
}
...
FString FUetkxCodegen::GeneratedCopyrightLine(const FString& Basename, TOptional<bool> bSellerRepoOverride)
{
	...
	return FString::Printf(
		TEXT("// Generated by Reactive UI Toolkit from %s.uetkx — this generated code belongs to your project.\n"),
		*Basename);
}
