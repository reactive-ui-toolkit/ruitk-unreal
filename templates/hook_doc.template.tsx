...
// Copy to RuitkUnrealDocs~/src/pages/Hooks/<HookName>Page.tsx, replace __TOKENS__, register the route
// in RuitkUnrealDocs~/src/docs.tsx + the nav in pages.tsx + searchIndex.ts (docs-sync's new-hook row).
