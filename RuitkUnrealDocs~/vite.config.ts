...
export default defineConfig({
  // Mounted under the family documentation site at <domain>/unreal/ (the `documentation` repo
  // aggregates every leg; this build is pushed into its /unreal/ folder by docs-sync.yml).
