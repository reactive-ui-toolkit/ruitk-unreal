...
const DRAW = `export FRuitkNode Chart() {
...
const TSharedPtr<FRuitkDrawFn>& ScatterFn =
	UseMemo<TSharedPtr<FRuitkDrawFn>>([]() { return Ruitk::Slate::MakeDrawFn(&DrawScatter); }, Ruitk::Deps());

<RuitkCanvas DrawFn={ ScatterFn } RedrawKey={ Tick } CanvasSize={ FVector2D(360.0f, 110.0f) } />`
...
export const CustomRenderingPage: FC = () => (
  <Box>
    ...
    <Typography variant="body1" paragraph>
      ...
      <code>RuitkCanvas</code> gives you a Slate paint surface driven declaratively. You supply a{' '}
    ...
    <Typography variant="body1" paragraph>
      <code>Ruitk::Slate::MakeDrawFn(...)</code> wraps a lambda of{' '}
      <code>(const FGeometry&amp;, FSlateWindowElementList&amp;, int32 Layer)</code> into an{' '}
      <code>FRuitkDrawFn</code>. Build it inside <code>UseMemo</code> so its identity is stable, and
